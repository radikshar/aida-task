...
@WebServlet(urlPatterns = {"/bus-journey/create", "/bus-journey/create/"})
public class CreateBusJourneyEndpoint extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        DatabaseManager.insertBusJourney(busJourney);
    }
}
